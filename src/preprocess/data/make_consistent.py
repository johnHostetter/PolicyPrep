...
def append_year_and_semester_to_user_id(
    ...
    for csv_file in csv_files:
        ...
        try:
            ...
            if "userID" in df.columns and df["userID"].min() < year_int + semester_int:
...
# def clean_semester_data(
#     semester_folder: Path, semester_name: str, config: Config
# ) -> None:
#     # clean the data by removing the offset used for wording problems
#     remove_offset(semester_folder, semester_name, config)
#
#     # remove any users that have NaN grades
#     remove_nan_grades(semester_folder, semester_name, config)
